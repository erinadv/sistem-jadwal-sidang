                        ...
                        <div class="col-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Detail Perkara</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="no_perkara" name="no_perkara" value="{{ $pkr->no_perkara }}" placeholder="No. Perkara">
                                        </div>
                                        <div class="form-group">
                                            <label>Terdakwa</label>
                                            <input type="text" class="form-control" id="terdakwa" name="terdakwa" value="{{ $pkr->terdakwa }}" placeholder="Nama Terdakwa">
                                        </div>
                                        {{-- <div class="form-group">
                                            <label>Hakim</label>
                                            <select class="form-control select2" id="id_hakim" name="id_hakim" style="width: 100%">
                                                <option disabled value>Pilih Hakim</option>
                                                <option value="{{ $hkm->hakim_id }}">{{ $hkm->nama_hakim }}</option>
                                                @foreach ($hkm as $item )
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control" id="tgl_sidang" name="tgl_sidang" value="{{ $pkr->tgl_sidang }}" placeholder="Tanggal Sidang">
                                        </div>
                                        {{-- <div class="form-group">
